//
//  CTProcessNavigationViewController.m
//  CartTracker
//
...
@interface CTProcessNavigationViewController ()

@end

@implementation CTProcessNavigationViewController
...
- (void)viewDidLoad
{
    ...
    self.viewControllers = @[processViewController];
